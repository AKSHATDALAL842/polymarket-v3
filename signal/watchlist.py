...
_WATCHLIST: list[tuple[str, str, float]] = [
    ...
    ("resigns", "YES", 0.90),
    # Financial/news YES signals — price moves, ETF flows, earnings
    ("surges", "YES", 0.78),
    ("rallies", "YES", 0.75),
    ("soars", "YES", 0.78),
    ("record high", "YES", 0.82),
    ("all-time high", "YES", 0.82),
    ("etf inflows", "YES", 0.78),
    ("etf approved", "YES", 0.88),
    ("beats expectations", "YES", 0.82),
    ("beats estimates", "YES", 0.82),
    ("revenue record", "YES", 0.82),
    ("profit surge", "YES", 0.80),
    ("exceeds", "YES", 0.78),
    ("surpasses", "YES", 0.78),
    ("resigned", "YES", 0.90),
    ("steps down", "YES", 0.88),
